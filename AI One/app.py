...
from Locomotive2 import UniversalDeepLearner
...
# SET BOOTSTRAP COUNT FOR DL-STARSYSTEM
BOOTSTRAP_COUNT = 100
...
def compute2():
    ...
    if request.methods == "GET":
        return render_template("compute2.html")
    else:
        data_injection = int(request.method.get("new_cash"))
        raw_data_9 = UniversalDeepLearner(data_injection) # raw_data2 THAT STEMS FROM DATA_INJECTION ACCOUNTS FOR ROW-DIMENSION OF data_injection


        for _ in range(BOOTSTRAP_COUNT):
            raw_data_9 = UniversalDeepLearner(raw_data_9)
            
     #   return redirect("/")

    return render_template("compute2.html", inference = raw_data_9)


# And like that have we integrated out Univesal Deep Learner into our Flask App.
